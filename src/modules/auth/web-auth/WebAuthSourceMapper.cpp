...
WebAuthSourceMapper::WebAuthSourceMapper(const std::string &auth_file) :
...
void WebAuthSourceMapper::visit(WiegandCard *src)
{
...
void WebAuthSourceMapper::visit(::Leosac::Auth::PINCode *src)
{
...
void WebAuthSourceMapper::visit(::Leosac::Auth::WiegandCardPin *src)
{
...
void WebAuthSourceMapper::mapToUser(IAuthenticationSourcePtr auth_source)
{
    assert(auth_source);
    try
    {
...
IAccessProfilePtr WebAuthSourceMapper::buildProfile(IAuthenticationSourcePtr auth_source)
{
    assert(auth_source);
...
void WebAuthSourceMapper::load_groups(const boost::property_tree::ptree &group_mapping)
{
...
std::vector<GroupPtr> WebAuthSourceMapper::groups() const
{
...
std::vector<GroupPtr> WebAuthSourceMapper::get_user_groups(Leosac::Auth::IUserPtr u)
{
    assert(u);
    std::vector<GroupPtr> grps;
...
IAccessProfilePtr WebAuthSourceMapper::merge_profiles(const std::vector<IAccessProfilePtr> profiles)
{
...
void WebAuthSourceMapper::load_credentials(const boost::property_tree::ptree &credentials)
{
...
void WebAuthSourceMapper::load_schedules(const boost::property_tree::ptree &schedules)
{
    bool ret = xml_schedules_.load(schedules);
    ASSERT_LOG(ret, "Failed to load schedules");
}

void WebAuthSourceMapper::map_schedules(const boost::property_tree::ptree &schedules_mapping)
{
...
void WebAuthSourceMapper::add_schedule_to_profile(const std::string &schedule_name,
...
void WebAuthSourceMapper::load_users(const boost::property_tree::ptree &users)
{
...
Leosac::Auth::CredentialValidity WebAuthSourceMapper::extract_credentials_validity(const boost::property_tree::ptree &node)
{
...
IAuthenticationSourcePtr WebAuthSourceMapper::find_cred_by_id(const std::string &id)
{
...
void WebAuthSourceMapper::add_cred_to_id_map(Leosac::Auth::IAuthenticationSourcePtr credential)
{
...
void WebAuthSourceMapper::enforce_xml_node_name(const std::string &expected,
