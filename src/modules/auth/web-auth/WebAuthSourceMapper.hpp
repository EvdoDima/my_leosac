...
namespace Leosac
{
    namespace Module
    {
        namespace Auth
        {
            ...
            */
            class WebAuthSourceMapper : public ::Leosac::Auth::IAuthSourceMapper
            {
              public:
                WebAuthSourceMapper(const std::string &auth_file);
        ...
        using WebAuthSourceMapperPtr = std::shared_ptr<WebAuthSourceMapper>;
        }
    }
}
